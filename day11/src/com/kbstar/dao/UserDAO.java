...
public class UserDAO implements DAO<String, UserDTO>{
	...
	public UserDTO select(String k) throws Exception {
		UserDTO obj = null;		//DB에서 해당하는 key값의 User객체를 끄집어내서 리턴한다
		obj = db.get(k);
		return obj;
	}

	@Override
	public List<UserDTO> select() throws Exception {	//List는 인터페이스라 ArrayList를 쓴다
